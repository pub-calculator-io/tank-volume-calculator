...
Version: 1.0.0
Author: Tank Volume Calculator / www.calculator.io
...
function display_calcio_ci_tank_volume_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_tank_volume_calculator', 'display_calcio_ci_tank_volume_calculator' );